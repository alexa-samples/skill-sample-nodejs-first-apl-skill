...
Now in our main document, we can remove everything except for the mainTemplate blob, and add in a new import for our package. In the authoring tool, we can use https://public-pics-muoio.s3.amazonaws.com/my-cakewalk-apl-package.json[this public link] to test. 
...
+
 {
    ...
    "version": "1.0",
    "source": "https://public-pics-muoio.s3.amazonaws.com/my-cakewalk-apl-package.json"
 }
+
...
https://github.com/JoeMoCode/CakeWalkAPL/tree/master/modules/code/module4[Complete code in Github]
