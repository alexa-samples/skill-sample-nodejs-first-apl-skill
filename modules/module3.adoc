...
C. In here, upload all of the assets {link-S3-assets}. For your convenience, we have the https://alexa.design/apl-cake-walk-assets[assets zipped here]. We will use all of these over the course of the module. After you upload, you will see all of the assets on the page in S3.
+
