...
* Training
** https://developer.amazon.com/alexa/alexa-skills-kit/get-deeper/tutorials-code-samples/build-an-engaging-alexa-skill[Tutorial: Build an Engaging Alexa Skill]
