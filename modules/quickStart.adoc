...
A. Open the https://developer.amazon.com/alexa/console/ask[developer console to the ASK page]. Sign in or create an Alexa developer account if you do not yet have one.
...
+
D. Upload the interaction model https://raw.githubusercontent.com/alexa/skill-sample-nodejs-first-skill/master/final/en-US.json[from here] to your skill. This is easy to do from the *build* tab. Copy paste the raw GitHub JSON into the "JSON Editor" which you can find on the left side.
